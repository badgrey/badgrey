...
async function seedPennsylvaniaArtists () {
  const artists = await Promise.all([
    ...
    Artist.create({name: 'Hardo', city: 'Wilkinsburgh', imageURL: 'hardo', soundcloudURL: 'https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/32357944&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true', youtubeID: [], genre: '', stateAbbrev: 'PA'})
  ])
  return artists
}
